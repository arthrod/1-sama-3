/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 3101afa731a9b9b36b600e0f8272945c)
// Runtime types generated with workerd@1.20251202.0 2025-03-25 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		CMS_CLIENT: string;
		NEXT_PUBLIC_KEYSTATIC_STORAGE_KIND: string;
		NEXT_PUBLIC_KEYSTATIC_STORAGE_REPO: string;
		KEYSTATIC_PATH_PREFIX: string;
		NEXT_PUBLIC_KEYSTATIC_CONTENT_PATH: string;
		KEYSTATIC_GITHUB_TOKEN: string;
		ASSETS: Fetcher;
	}
}
