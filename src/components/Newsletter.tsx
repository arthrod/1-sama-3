						...
						<AnimatePresence mode="wait">
							{status === "success" ? (
								<motion.div
									...
									aria-live="polite"
								>
									<div className="w-12 h-12 rounded-full bg-merlot text-white flex items-center justify-center mb-2">
										<svg
								...
								<motion.form
									...
									className="flex flex-col md:flex-row gap-4 max-w-md mx-auto w-full"
								>
