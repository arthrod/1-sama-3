	...
	return (
		...
		>
			...
			<div className="max-w-4xl mx-auto px-6 text-center relative z-10">
				<div className="inline-block border-2 border-dotted border-graphite px-8 py-16 bg-black/50 backdrop-blur-sm relative w-full max-w-3xl">
					{/* Corner Accents */}
						...
						<AnimatePresence mode="wait">
							{status === "success" ? (
								<motion.div
									...
									aria-live="polite"
								>
									<div className="w-12 h-12 rounded-full bg-merlot/20 flex items-center justify-center text-merlot mb-2">
										<svg
									...
									<p className="text-graphite-lighter text-sm mb-4">
										Obrigado por se juntar à nossa lista exclusiva.
									</p>
									<button
										type="button"
										onClick={() => setStatus("idle")}
										className="text-xs uppercase tracking-widest text-merlot-light hover:text-paper transition-colors underline decoration-merlot-light/30 underline-offset-4"
									>
								...
								<motion.form
									...
									className="w-full flex flex-col md:flex-row gap-4 max-w-md mx-auto"
								>
									...
									<input
										...
										className="flex-1 bg-transparent border-b border-graphite py-3 px-4 text-paper placeholder-graphite-light focus:outline-none focus:border-merlot transition-colors font-serif w-full"
									...
									<button
										...
										id="subscribe-btn"
										disabled={status === "loading"}
										className="bg-paper text-ink hover:bg-merlot hover:text-white font-sans font-bold uppercase tracking-widest text-xs py-4 px-8 transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
									>
										{status === "loading" ? (
