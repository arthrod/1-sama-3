...
// JSON-LD graph inspired by your HTML <script type="application/ld+json">
const jsonLd = {
...
// Rich SEO metadata, matching the HTML <head>
...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR" suppressHydrationWarning>
      ...
      >
        {/* JSON-LD injected once for all pages */}
        <script
          type="application/ld+json"
          // Static JSON; safe to stringify at build/SSR time
